...
int main(int argc, char *argv[])
{
	...
	t0 = get_wtime();
	int num_threads = 16;
    #pragma omp parallel num_threads(num_threads) firstprivate(fx, jj, i) /*Starts Parallelization and Creates Threads with num_threads(int) parameter, we use firstprivate to initialize our values*/
    {
